...
//Groups of obj0
   ...
   float4 group1 = OP_SmoothSubtraction(obj2,obj0,obj2sm);
   float4 group2 = OP_SmoothSubtraction(obj3,obj0,obj3sm);
   float4 group3 = OP_SmoothSubtraction(obj4,obj0,obj4sm);
