...
//Groups of obj3
   float2 group0 = OP_SmoothSubtraction(obj4,obj3,_MASrenderSmoothness,_MASrenderColorSmoothness);
...
//-----Registered Final Groups & Single Objects
   float2 group1 = OP_SmoothUnion(group0,obj0,_MASrenderSmoothness);
   float2 group2 = OP_SmoothUnion(group1,obj1,_MASrenderSmoothness);
   float2 group3 = OP_SmoothUnion(group2,obj2,_MASrenderSmoothness);
