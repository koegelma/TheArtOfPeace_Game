...
//Groups of obj6
   float4 group0 = OP_SmoothSubtraction(obj9,obj6,obj9sm);
   float4 group1 = OP_SmoothSubtraction(obj9,obj6,obj9sm);

//-----Connected Advanced Operators - Straight Unions
//Connection Group of obj6
   float4 group2 = OP_StraightUnion(group0,group1,_MASrenderColorSmoothness);

//-----Connected Advanced Operators - Smooth Unions


//-----Registered Final Groups & Single Objects
   float4 group3 = OP_SmoothUnion(group2,obj1,_MASrenderSmoothness);
   float4 group4 = OP_SmoothUnion(group3,obj2,_MASrenderSmoothness);
   float4 group5 = OP_SmoothUnion(group4,obj3,_MASrenderSmoothness);
   float4 group6 = OP_SmoothUnion(group5,obj4,_MASrenderSmoothness);
   float4 group7 = OP_SmoothUnion(group6,obj5,_MASrenderSmoothness);
   float4 group8 = OP_SmoothUnion(group7,obj7,_MASrenderSmoothness);
   float4 group9 = OP_SmoothUnion(group8,obj8,_MASrenderSmoothness);
   result = group9;
   return result;
}