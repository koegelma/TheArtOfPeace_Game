Shader "Matej Vanco/RayMarcher/PC/RM Master_Example_PCVR_Default"
{
	...
	SubShader
	{
		...
		Pass
		{
			CGPROGRAM
				...
				#include "ShapeSources\Raymarch_ShapesSource_Example_PCVR_Default.cginc"

				#include "Includes\PC\Raymarch_FractsSource.cginc"

				#include "ObjectBuffers\Raymarch_ObjectBuffer_Example_PCVR_Default.cginc"	
