Shader "Matej Vanco/RayMarcher/Mobile/RM Master_Example_MobileVR_Primitives"
{
	...
	{	
		...
		Pass
		{
			CGPROGRAM
				...
				#include "Includes\Mobile\Raymarch_VertVR.cginc"

				#include "Includes\Mobile\Raymarch_Operators.cginc"

				#include "ShapeSources\Raymarch_ShapesSource_Example_MobileVR_Primitives.cginc"

				#include "Includes\Mobile\Raymarch_FractsSource.cginc"

				#include "ObjectBuffers\Raymarch_ObjectBuffer_Example_MobileVR_Primitives.cginc"	

				#include "Includes\Mobile\Raymarch_CoreVR.cginc"

				#include "Includes\Mobile\Raymarch_FragVR.cginc"
