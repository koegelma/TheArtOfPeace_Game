Shader "Matej Vanco/RayMarcher/Mobile/RM Master_Example_Mobile_Centipede"
{
	...
	{	
		...
		Pass
		{
			CGPROGRAM
				...
				#include "ShapeSources\Raymarch_ShapesSource_Example_Mobile_Centipede.cginc"

				#include "Includes\Mobile\Raymarch_FractsSource.cginc"

				#include "ObjectBuffers\Raymarch_ObjectBuffer_Example_Mobile_Centipede.cginc"	
