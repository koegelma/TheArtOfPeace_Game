Shader "Matej Vanco/RayMarcher/PC/RM Master_Example_Fractals"
{
	...
	SubShader
	{
		...
		Pass
		{
			CGPROGRAM
				...
				#include "ShapeSources\Raymarch_ShapesSource_Example_Fractals.cginc"

				#include "Includes\PC\Raymarch_FractsSource.cginc"

				#include "ObjectBuffers\Raymarch_ObjectBuffer_Example_Fractals.cginc"	
