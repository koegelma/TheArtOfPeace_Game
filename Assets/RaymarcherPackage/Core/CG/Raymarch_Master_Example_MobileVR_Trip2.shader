Shader "Matej Vanco/RayMarcher/Mobile/RM Master_Example_MobileVR_Trip2"
{
	...
	{	
		...
		Pass
		{
			CGPROGRAM
				...
				#include "ShapeSources\Raymarch_ShapesSource_Example_MobileVR_Trip2.cginc"

				#include "Includes\Mobile\Raymarch_FractsSource.cginc"

				#include "ObjectBuffers\Raymarch_ObjectBuffer_Example_MobileVR_Trip2.cginc"	
